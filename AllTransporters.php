...
<body>
	...
	<div class="container">
		<div>
			<h1 align="center">transporters</h1>
			<table id="datatable" ">
				<tr>
					<td>Id</td>
					<td>Name</td>
				...
				while ($result = mysqli_fetch_array($output)){
					...
					echo "
							<td>$result[0] </td>
	 					  	...
	 					  	<td>0$result[5]</td>
	 					  	<td>$result[4]</td>
	 					  	<td><a href='profileViewAdmin.php?id=$result[0]&type=transporter'><button>View</button></a></td>
							<td><a href='updateAdmin.php?id=$result[0]&type=transporter'><button>Update</button></a></td>
